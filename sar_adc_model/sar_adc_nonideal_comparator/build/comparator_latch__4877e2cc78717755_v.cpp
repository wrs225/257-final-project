//========================================================================
// Vcomparator_latch__4877e2cc78717755_v.cpp
//========================================================================
...
#include "obj_dir_comparator_latch__4877e2cc78717755/Vcomparator_latch__4877e2cc78717755.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_comparator_latch__4877e2cc78717755/Vcomparator_latch__4877e2cc78717755__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  #if VLINETRACE
  void trace( Vcomparator_latch__4877e2cc78717755_t *, char * );
  #endif
...
Vcomparator_latch__4877e2cc78717755_t * create_model( const char *vcd_filename ) {

  Vcomparator_latch__4877e2cc78717755_t * m;
  Vcomparator_latch__4877e2cc78717755   * model;

  Verilated::randReset( 0 );
  Verilated::randSeed( 0 );

  m     = (Vcomparator_latch__4877e2cc78717755_t *) malloc( sizeof(Vcomparator_latch__4877e2cc78717755_t) );
  model = new Vcomparator_latch__4877e2cc78717755();
...
void destroy_model( Vcomparator_latch__4877e2cc78717755_t * m ) {

  #if VM_COVERAGE
    VerilatedCov::write( "coverage.dat" );
  #endif

  Vcomparator_latch__4877e2cc78717755 * model = (Vcomparator_latch__4877e2cc78717755 *) m->model;
...
void comb_eval( Vcomparator_latch__4877e2cc78717755_t * m ) {
...
void seq_eval( Vcomparator_latch__4877e2cc78717755_t * m ) {
...
#if VLINETRACE
void trace( Vcomparator_latch__4877e2cc78717755_t * m, char* str ) {
  ...
  svSetScope( &model->__VlSymsp->__Vscope_comparator_latch___05F4877e2cc78717755__v );
