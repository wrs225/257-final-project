...
comparator_latch_fsm.preprocessHierarchy(rel_prec = 0.002, override_dict = {'wait_time':intlib.IntType(nbits = 32, scale = 1.0, signed = 0), 'wait_time_lh':intlib.IntType(nbits = 32, scale = 1.0, signed = 0)})
